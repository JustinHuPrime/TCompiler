...
\lstinputlisting[breaklines=true, firstline=29, lastline=46]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=48, lastline=48]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, linerange={53-53, 60-61}]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=54, lastline=54]{"Appendix B - Syntax.ebnf"}
...
A return statement returns from the current function. If an expression is provided, it must match the return type of the function, and the value of the expression will be the returned value. If a value is not provided, then the function must return void.
...
\lstinputlisting[breaklines=true, firstline=63, lastline=65]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=66, lastline=81]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=82, lastline=84]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=85, lastline=85]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=87, lastline=88]{"Appendix B - Syntax.ebnf"}

Comparisons are valid for base types can be merged in a comparison type merge, and result in an rvalue boolean.

\subsection{Shift Operators}

\lstinputlisting[breaklines=true, firstline=89, lastline=89]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=92, lastline=100]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, linerange={101-101, 109-109}]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=102, lastline=108]{"Appendix B - Syntax.ebnf"}
...
\lstinputlisting[breaklines=true, firstline=115, lastline=125]{"Appendix B - Syntax.ebnf"}
