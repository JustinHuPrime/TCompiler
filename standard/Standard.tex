...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Each file scope declaration is inspected, and the details for the declaration are recorded. What an identifier references is resolved at this point.
		
		\item Each unparsed body is then parsed using the information from the first pass, while simultaneously, details about any declarations are recorded. What an identifier references is resolved at this point.
	\end{enumerate}
