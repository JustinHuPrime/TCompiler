...
//       parseDeclFile(report, options, dependencyInfo, infoTable,
//       typenameTable,
//                     nodeTable);
...
//   typenameSetTablePut(typenameTable, info->moduleName,
...
//     parseDeclFile(report, options, infoTable->values[idx], infoTable,
//     typenames,
//                   pair->decls);
//   }
