...
char const *const KEYWORD_STRINGS[] = {
    ...
    "default", "break",  "continue", "return",   "cast",  "sizeof", "true",
    "false",   "null",   "void",     "ubyte",    "byte",  "char",   "ushort",
