...
char const *const TOKEN_NAMES[] = {
    ...
    "CONST",         "VOLATILE",     "SEMI",
    "COMMA",         "LPAREN",       "RPAREN",
    "LSQUARE",       "RSQUARE",      "LBRACE",
    "RBRACE",        "DOT",          "ARROW",
    "INC",           "DEC",          "STAR",
    "AMP",           "PLUS",         "MINUS",
    "BANG",          "TILDE",        "NEGASSIGN",
    "LNOTASSIGN",    "NOTASSIGN",    "SLASH",
    "PERCENT",       "LSHIFT",       "ARSHIFT",
    "LRSHIFT",       "LANGLE",       "RANGLE",
    "LTEQ",          "GTEQ",         "EQ",
    "NEQ",           "BAR",          "CARET",
    "LAND",          "LOR",          "QUESTION",
    "COLON",         "ASSIGN",       "MULASSIGN",
    "DIVASSIGN",     "MODASSIGN",    "ADDASSIGN",
    "SUBASSIGN",     "LSHIFTASSIGN", "ARSHIFTASSIGN",
    "LRSHIFTASSIGN", "ANDASSIGN",    "XORASSIGN",
    "ORASSIGN",      "LANDASSIGN",   "LORASSIGN",
    "SCOPE",         "ID",           "LIT_STRING",
    "LIT_WSTRING",   "LIT_CHAR",     "LIT_WCHAR",
    "LIT_INT_0",     "LIT_INT_B",    "LIT_INT_O",
    "LIT_INT_D",     "LIT_INT_H",    "LIT_DOUBLE",
    "LIT_FLOAT",     "BAD_STRING",   "BAD_CHAR",
    "BAD_BIN",       "BAD_HEX",
};
